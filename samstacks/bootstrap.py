                ...
                try:
                    ...
                    with open(
                        ...
                        if file_to_parse.suffix == ".toml":
                            ...
                            print(f"DEBUG: Successfully parsed TOML: {stack_obj.samconfig_data}")
                            self.logger.debug(
                            ...
                            print(f"DEBUG: Successfully parsed YAML: {stack_obj.samconfig_data}")
                            self.logger.debug(
                    ...
                    print(f"DEBUG: FileNotFoundError for samconfig file: {file_to_parse}")
                    ...
                    print(f"DEBUG: Unexpected error for samconfig file {file_to_parse}: {e}")
                    stack_obj.samconfig_data = None
            else:
                print(f"DEBUG: No samconfig file found for stack {stack_obj.id} (path: {stack_obj.samconfig_path})")
    ...
    def _consolidate_samconfigs(
        ...
        for stack_obj in self.discovered_stacks:
            if stack_obj.samconfig_data:
                ...
                print(f"DEBUG: Stack {stack_obj.id} samconfig_data: {stack_obj.samconfig_data}")
            else:
        ...
        print(f"DEBUG: sanitized_configs:")
